...
public class TutorialGroupController {
    ...
    private ProgrammeInitializer programmeDAO;
    private StudentInitializer studentDAO;
    private TutorialGrpInitializer tutorialGrpInitializer;
    
    public TutorialGroupController() {
        this.programmeDAO = new ProgrammeInitializer();
        this.programmeDAO.insertSampleData();
        this.programmeList = programmeDAO.getProgrammeList();  // Initialize programmeList from DAO
